...
# --- PAGE CONFIGURATION & ICON UPDATED ---
st.set_page_config(page_title="PageWhisperer - Chatbot", page_icon="📖")
...
def render_chatbot_page() -> None:
    ...
    # --- PAGE TITLE UPDATED ---
    st.title("PageWhisperer - Chatbot 📖")
    ...
    # --- SIDEBAR LOGO PATH & WIDTH UPDATED ---
    # To use this, save your new logo file locally on your Mac as "pagewhisperer_logo.png"
    # and place it inside the "images/" folder within your project directory.
    logo_path = "images/pagewhisperer_logo.png"
    if os.path.exists(logo_path):
        # Slightly wider for better detail on the vector design
        st.sidebar.image(logo_path, width=250)
        logger.info("New PageWhisperer logo displayed.")
    else:
        st.sidebar.markdown("### Logo Placeholder")
        logger.warning("New PageWhisperer logo not found at images/pagewhisperer_logo.png, displaying placeholder.")

    # Sidebar headers and footer
    # --- SIDEBAR TEXT HEADERS UPDATED ---
    st.sidebar.markdown(
        "<h2 style='text-align: center;'>PageWhisperer</h2>", unsafe_allow_html=True
    )
    st.sidebar.markdown(
        "<h4 style='text-align: center;'>Whispering Insights from Your Documents</h4>",
        unsafe_allow_html=True,
    )

    # Footer text
    # --- SIDEBAR FOOTER COPYRIGHT UPDATED ---
    st.sidebar.markdown(
        """
    ...
    logger.info("Sidebar configured with new branding.")
