...
st.set_page_config(
    page_title="PageWhisperer - Welcome", page_icon="📖"
)
...
def display_main_content() -> None:
    ...
    # --- MAIN TITLE & CONTENT UPDATED ---
    st.title("PageWhisperer - Welcome 📖")
    st.markdown(
        """
        Welcome to PageWhisperer, your private AI document assistant! 📖
                
        This app allows you to interact with an AI-powered assistant and upload documents for processing and retrieval entirely locally.
...
def display_sidebar_content() -> None:
    ...
    # --- SIDEBAR HEADERS AND FOOTER UPDATED ---
    st.sidebar.markdown(
        "<h2 style='text-align: center;'>PageWhisperer</h2>", unsafe_allow_html=True
    )
    st.sidebar.markdown(
        "<h4 style='text-align: center;'>Your Private Document Assistant</h4>",
        unsafe_allow_html=True,
    )
    st.sidebar.markdown(
        """
...
if __name__ == "__main__":
    apply_custom_css()
    # --- LOGO PATH UPDATED ---
    display_logo("images/pagewhisperer_logo.png")
